...
<div class="layui-container">
    ...
    <form class="layui-form" action="UserServlet?type=save" method="post" style="width: 500px;margin: 50px auto;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="role" id="role" value="学生" lay-verify autocomplete="off"
